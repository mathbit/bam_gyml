...
\begin{Add}{HaeK}{basal1.2}{Funktionen,Mathematisieren}{einfach}
    \question{
    Übersetze die Situation \glqq Ein Stalagmit ist anfänglich 2m hoch und wächst in jedem Jahr um einen cm\grqq\ in eine Funktion der Zeit (wobei die Zeit in Jahren gemesssen wird).
    } 
...
\begin{Add}{RoK}{basal2}{Mathematisieren}{mittel}
    \question{
        Wird auf beiden Seiten einer zweistelligen natürlichen Zahl die Ziffer 5 hinzugefügt, so ergibt sich das 75-fache der Zahl. Wie heisst die Zahl?
    }
    \solution{
        $\frac{1001}{13}=77$
    }
...
\begin{Add}{RoK}{basal1}{Kreisberechnung}{leicht}
    \question{
        Ein Velorad hat einen Durchmesser von 28 Zoll. Ein Zoll entspricht 2.54 cm. Wie weit fährt das Velo mit einer Radumdrehung?
    }
    \solution{
        223.43 cm
    }
