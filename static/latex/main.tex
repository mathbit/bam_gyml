...
\begin{Add}{BiT}{basal1}{Grundoperationen}{leicht}
    \question{Vereinfache $a+a+a$}  \solution{$3a$}
\end{Add}
...
\begin{Add}{WiD}{basal1}{Dreieck}{leicht}
    \question{
        In welchem Dreieck entspricht eine Scwerelinie gerade einer Winkelhalbierenden?
        } 
...
\begin{Add}{RoK}{basal1}{Dreieck,Proportionalitäten,Mathematisieren}{mittel}
    \question{
        Die drei Innenwinkel eines Dreiecks verhalten sich wie $7:8:9$. Wie gross sind die drei Winkel?
    }
    \solution{
        $105^\circ$, $120^\circ$ und $135^\circ$
    }
\end{Add}
