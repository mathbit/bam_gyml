...
\end{Add}
            ...
            \begin{Add}{HaeK}{basal1.1}{Arithmetik,Wurzelterme}{schwerer}
...
\vspace{-0.2cm}
 ...
 \vspace{-0.2cm} }
     ...
     \begin{Add}{HaeK}{basal1.2}{Geometrie}{schwerer}
...
\end{Add}
         ...
         \begin{Add}{HaeK}{basal1.2}{Funktionen}{schwerer}
...
\begin{Add}{HaeK}{basal1.2}{Funktionen,Mathematisieren}{schwerer}
...
\end{Add}
    ...
    \begin{Add}{WiD}{basal1.2}{Geometrie}{schwerer}
...
\end{itemize} }
    ...
    \begin{Add}{WiD}{basal1.1}{Algebra,Bruchterme}{schwerer}
    \question{ Vereinfache soweit als möglich 
...
\begin{Add}{WiD}{basal1.2}{Geometrie,Koordinatensystem}{schwerer}
...
\begin{Add}{WiD}{basal1.1}{Koordinatensystem,Geometrie}{schwerer}
...
\[ 3x-6y-2(1+4x-3y) \] }
    ...
    \begin{Add}{WiD}{basal1.1}{Algebra,Grundoperationen}{schwerer}
    \question{ Vereinfache soweit als möglich:
...
\[ 3x+4y-\framebox[10mm]{\rule{0mm}{3mm}}=x-y \] }
    ...
    \begin{Add}{WiD}{basal1.1}{Algebra,Gleichungen,Bruchterme}{schwerer}
    \question{ Welcher Term muss im Kasten \framebox[10mm]{\rule{0mm}{3mm}} stehen, damit die Gleichung erfüllt ist?
...
\[ 2-2\sqrt{1-\tfrac{1}{3}} \] }
    ...
    \begin{Add}{WiD}{basal0}{Arithmetik,Bruchterme,Wurzelterme,Grundoperationen}{schwerer}
    \question{ Berechne mit dem Taschenrechner und runde auf 4 signifikante Stellen: 
...
\[ -\frac{-2\cdot3ab}{4b} \] }
    ...
    \begin{Add}{WiD}{basal1.1}{Arithmetik,Wurzelterme}{schwerer}
...
\begin{Add}{WaJ}{basal0}{Sachrechnen}{schwerer}
...
\end{Add}
    ...
    \begin{Add}{WaJ}{basal1.2}{Funktionen}{schwerer}
...
\begin{Add}{WaJ}{basal1.1}{Algebra,Grundoperationen}{schwerer}
...
\end{Add}
    ...
    \begin{Add}{WaJ}{basal1.1}{Geometrie,Grundoperationen}{schwerer}
...
\begin{Add}{WaJ}{basal1.1}{Geometrie}{schwerer}
...
\begin{Add}{WaJ}{basal1.1}{Algebra}{schwerer}
...
\begin{Add}{WaJ}{basal0}{Geometrie}{schwerer}
...
\begin{Add}{RoK}{basal0}{Arithmetik,Geometrie,Mathematisieren}{schwerer}
...
\end{Add}
    ...
    \begin{Add}{RoK}{basal1.1}{Mathematisieren,Gleichungen,Lineares}{schwerer}
...
$$5000+10x+5=75x$$ }
    ...
    \begin{Add}{RoK}{basal1.1}{Algebra}{schwerer}
    \question{ Löse die Gleichung nach $x$ auf:
...
\end{Add}
    ...
    \begin{Add}{RoK}{basal1.1}{Grundoperationen,Arithmetik,Wurzelterme}{schwerer}
...
\begin{Add}{RoK}{basal1.1}{Algebra,Lineares}{schwerer}
...
\begin{Add}{RoK}{basal0}{Arithmetik,Grundoperationen}{schwerer}
...
\begin{Add}{RoK}{basal0}{Mathematisieren,Sachrechnen}{schwerer}
...
\begin{Add}{RoK}{basal0}{Sachrechnen}{schwerer}
...
$$(2a \cdot 3b)\cdot 2a=\;?$$ }
    ...
    \begin{Add}{MaI}{basal0}{Mathematisieren}{schwerer}
...
\begin{Add}{MaI}{basal1.1}{Mathematisieren,Gleichungen}{schwerer}
...
\end{Add}
     ...
     \begin{Add}{MaI}{basal1.2}{Funktionen}{schwerer}
...
$$\left(1+\frac{b-a}{a}\right)\cdot\left(1-\frac{b}{b-a}\right)$$ }
   ...
   \end{Add}
    ...
    \begin{Add}{MaI}{basal1.2}{Lineares,Funktionen}{schwerer}
...
\end{Add}
        ...
        \begin{Add}{ScM}{basal1.1}{Mathematisieren}{schwerer}
...
\begin{Add}{ScM}{basal0}{Sachrechnen}{schwerer}
...
\begin{Add}{ScM}{basal1.1}{Algebra}{schwerer}
...
\begin{Add}{JcD}{basal0}{Koordinatensystem}{schwerer}
...
\end{Add}
        ...
        \begin{Add}{JcD}{basal0}{Grundoperationen}{schwerer}
        \question{ Vereinfache so weit wie möglich.
...
\begin{Add}{JcD}{basal0}{Arithmetik}{einfach}
...
\begin{Add}{JcD}{basal0}{Geometrie}{schwerer}
...
\end{Add}
        ...
        \begin{Add}{JcD}{basal1.1}{Mathematisieren}{schwerer}
...
\begin{Add}{JcD}{basal1.1}{Sachrechnen}{schwerer}
...
\begin{Add}{JcD}{basal0}{Sachrechnen,Geometrie}{schwerer}
...
\end{Add}
        ...
        \begin{Add}{JcD}{basal1.1}{Quadratisches,Geometrie}{schwerer}
...
\begin{Add}{JcD}{basal0}{Grundoperationen,Bruchterme}{schwerer}
...
\begin{Add}{JcD}{basal1.1}{Grundoperationen,Bruchterme}{schwerer}
...
\begin{Add}{GiD}{basal0}{Mathematisieren}{schwerer}
...
\end{Add}
        ...
        \begin{Add}{GiD}{basal0}{Geometrie}{schwerer}
