...
\begin{Add}{BiT}{basal0}{Grundoperationen,Algebra}{einfach}
\question{ Vereinfache $2a\cdot 4a\cdot 6a$ }
\solution{ }
\end{Add}
\begin{Add}{BiT}{basal0}{Grundoperationen,Algebra}{einfach}
\question{ Vereinfache $2a\cdot 4a\cdot 6a$ }
...
\begin{itemize}
    ...
    \item[d)] $\sqrt{\frac{64}{121}}=\frac{\sqrt{64}}{\sqrt{121}}$
\end{itemize} }
    \solution{ }
    \end{Add}
    \begin{Add}{WiD}{basal1.1}{Arithmetik,Wurzelterme}{schwieriger}
...
\question{ Der Preis einer Hose wird um 10\% reduziert und anschliessend um 11\% erhöht. Ist sie jetzt teurer, billiger oder gleich teuer wie zu Beginn? }
\solution{ }
\end{Add}
\begin{Add}{WiD}{basal1.1}{Sachrechnen,Mathematisieren}{schwieriger}
\question{ Der Preis einer Hose wird um 10\% reduziert und anschliessend um 11\% erhöht. Ist sie jetzt teurer, billiger oder gleich teuer wie zu Beginn? }
...
\] }
    ...
    \question{ Bestimme die Lösungsmenge der folgenden Gleichung: 
...
$$\frac{2z^2}{6z}$$ }
    ...
    \begin{Add}{WaJ}{basal1.1}{Algebra}{schwieriger}
    \question{ Addiere und vereinfache so weit wie möglich:
$$\frac{1}{a}+\frac{a-1}{a+1}$$ }
    ...
    \question{ Addiere und vereinfache so weit wie möglich:
$$\frac{1}{a}+\frac{a-1}{a+1}$$ }
    \solution{ $\frac{a^2+1}{a(a+1)}$ }
    \end{Add}
    

    \begin{Add}{WaJ}{basal1.1}{Algebra}{schwieriger}
    \question{ Subtrahiere und vereinfache so weit wie möglich:
...
$$(-x-3)^2$$ }
    ...
    \question{ Bestimme $x$ für die Gleichung:
$$4x-7=-6x-2$$ }
    \solution{ }
    \end{Add}
    \begin{Add}{WaJ}{basal1.1}{Gleichungen}{einfach}
...
$$(10)^{-3}=-30$$ }
    ...
    \question{ Richtig oder falsch:
$$(10)^{-3}=-30$$ }
    \solution{ falsch, $\frac{1}{10^3}=\frac{1}{1000}$ }
    \end{Add}
...
\begin{Add}{WaJ}{basal1.1}{Algebra}{schwieriger}
\question{ Wie viel sind $20\,\%$ von $25\,\%$ von $80$? }
\solution{ }
\end{Add}
\begin{Add}{WaJ}{basal1.1}{Algebra}{schwieriger}
\question{ Wie viel sind $20\,\%$ von $25\,\%$ von $80$? }
\solution{ $80\cdot25\,\%=20$, und $20\cdot20\,\%=4$ }
\end{Add}

\begin{Add}{WaJ}{basal1.1}{Algebra}{schwieriger}
\question{ Wie viel sind $25\,\%$ von $20\,\%$ von $80$? }
\solution{ }
\end{Add}
\begin{Add}{WaJ}{basal1.1}{Algebra}{schwieriger}
\question{ Wie viel sind $25\,\%$ von $20\,\%$ von $80$? }
\solution{ $80\cdot20\,\%=16$, und $16\cdot25\,\%=4$ }
\end{Add}
...
\begin{Add}{WaJ}{basal1.1}{Algebra}{einfach}
\question{ Wie viel sind $24\,\%$ von $300$? }
\solution{ }
\end{Add}
\begin{Add}{WaJ}{basal1.1}{Algebra}{einfach}
\question{ Wie viel sind $24\,\%$ von $300$? }
...
\begin{Add}{WaJ}{basal1.1}{Algebra}{einfach}
\question{ Wie viel sind $24$ zu $300$ in Prozent? }
\solution{ }
\end{Add}
\begin{Add}{WaJ}{basal1.1}{Algebra}{einfach}
\question{ Wie viel sind $24$ zu $300$ in Prozent? }
...
\begin{enumerate}
    ...
    \item[d)] $\frac{1}{6}=\frac{3}{8}$
\end{enumerate} }
    \solution{ keine, $\frac{1}{6}=0.1\overline{6}$ }
    \end{Add}
...
Die Gleichungen $x=2x-3$ und $x^2=9$ sind 
\"aquivalent (haben dieselbe Lösungsmenge). }
    \solution{ falsch: Die erste hat Lösung $3$, die zweite aber $3$ und $-3$. }
    \end{Add}
...
\begin{align*}
    ...
    \frac{1}{2x} &=\frac{1}{x}+\frac{1}{3}
\end{align*} }
    \solution{ falsch: $\frac{1}{2x} =\frac{1}{x+3}$ }
    \end{Add}
...
\begin{Add}{RoK}{basal0}{Geometrie,Lineares}{einfach}
\question{ Ein Velorad hat einen Durchmesser von 28 Zoll. Ein Zoll entspricht 2.54 cm. Durch welche Rechnung kannst du ermitteln, wie weit das Velo mit einer Radumdrehung fährt? }
\solution{ $28\cdot 2.54\cdot \pi$ cm }
\end{Add}
...
\end{Add}
    ...
    \question{ Welche Grössen entsprechen einem Volumen von 700 $cm^3$?\\
a) 7 $dl$\\
b) 7000 $mm^3$\\
c) 70 $dm^3$\\
d) 0.0007 $m^3$ }
...
\question{ Sei $x=-6$ und $y=4$. Berechne $x^2+y$. }
\solution{ }
\end{Add}
\begin{Add}{RoK}{basal0}{Algebra}{einfach}
\question{ Sei $x=-6$ und $y=4$. Berechne $x^2+y$. }
...
\begin{Add}{RoK}{basal0}{Algebra}{einfach}
\question{ Es gilt $x=2$ und $2x-(y-1)=-1$. Berechne $y$. }
\solution{ }
\end{Add}
\begin{Add}{RoK}{basal0}{Algebra}{einfach}
\question{ Es gilt $x=2$ und $2x-(y-1)=-1$. Berechne $y$. }
...
\begin{Add}{RoK}{basal0}{Algebra}{einfach}
\question{ Es gilt $y=6$ und $2x-(y-1)=-1$. Berechne $x$. }
\solution{ }
\end{Add}
\begin{Add}{RoK}{basal0}{Algebra}{einfach}
\question{ Es gilt $y=6$ und $2x-(y-1)=-1$. Berechne $x$. }
...
Bestimme den Funktionswert von g an der Stelle $x=0$.\\ }
    ...
    \question{ Vereinfache falls möglich:
$$\sqrt{a^2+b^2}=\;?$$
$$\sqrt{a^2 \cdot b^2}=\;?$$
$$\sqrt{\frac{a^2}{b^2}}=\;?$$ }
    \solution{ }
...
$$\sqrt{\frac{x}{y}}\cdot\sqrt{\frac{y^2}{x}}\cdot \sqrt{\frac{y^3}{x^2}}=\;?$$ }
    ...
    \question{ Löse die folgende Gleichung:
$$x=2\cdot\sqrt{x^2-1}$$ }
    \solution{ }
    \end{Add}
    \begin{Add}{MaI}{basal1.2}{Gleichungen,Wurzelterme}{schwieriger}
    \question{ Löse die folgende Gleichung:
$$x=2\cdot\sqrt{x^2-1}$$ }
    \solution{ $x=\frac{2}{\sqrt{3}}=\frac{2\sqrt{3}}{3}$ }
    \end{Add}
